  ...
  if(profile?.role!=='admin') return (
    <div className="flex min-h-screen items-center justify-center p-6 pt-28">
      <div className="glass-card w-full max-w-md p-8 text-center">
        ...
        <p className="mb-6 text-white/55">Your role is <span className="font-bold text-funky-cyan">{profile?.role||'student'}</span>. Admin access required.</p>
        <div className="mb-6 rounded-2xl border border-white/10 bg-dark-700/60 p-4 text-left text-sm text-white/50">
          <p className="mb-1 font-bold text-funky-lime">How to become admin:</p>
          <ol className="list-decimal list-inside space-y-1">
            <li>Go to <a href="https://console.firebase.google.com" target="_blank" className="text-funky-cyan underline" rel="noreferrer">Firebase Console</a></li>
            <li>Open Firestore → users collection</li>
            <li>Find your UID document</li>
            <li>Set <code className="text-funky-orange">role = "admin"</code></li>
            <li>Refresh page</li>
          </ol>
        </div>
        <Link href="/" className="btn-primary w-full py-3">Back to Home</Link>
      </div>
    </div>
  );
