      ...
      <div className="section-container relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
              ...
              return (
                <div
                  ...
                  className={`glass-card p-6 cursor-pointer relative transition-all duration-300 ${
                    isActive 
                      ? 'border-[#0B071E] scale-[1.02] shadow-[8px_8px_0px_#0B071E]' 
                      : 'border-dark/8 opacity-75 hover:opacity-100 hover:scale-[1.01] hover:border-dark/30'
                  }`}
                  style={{
                ...
                >
                  ...
                  <div className="flex gap-4 items-start relative z-10">
                    ...
                    <div className="flex flex-col items-center">
                      <div 
                        className={`w-10 h-10 rounded-xl flex items-center justify-center font-display font-black text-base border-2 transition-transform duration-300 ${
                          isActive ? 'scale-110' : ''
                        }`}
                        style={{
                          backgroundColor: isActive ? step.color : '#FFFFFF',
                          borderColor: '#0B071E',
                          color: isActive ? '#0B071E' : '#8E8A9E',
                          boxShadow: isActive ? `2px 2px 0px #0B071E` : 'none'
                        }}
                      >
                        {step.id + 1}
                      </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[10px] font-black uppercase tracking-wider text-purple font-semibold">
                          {step.badge}
                        </span>
                        {isActive && (
                          <motion.div 
                      ...
                      <h3 className="font-display font-black text-xl text-[#0B071E] mb-1">
                        {step.title}
                      </h3>
                      <p className="text-[#0B071E]/80 text-xs font-black mb-2 opacity-80">
                        {step.subtitle}
                      </p>
                      ...
                      <AnimatePresence initial={false}>
                        {isActive && (
                          <motion.p
                            ...
                            className="text-text-secondary text-sm font-medium leading-relaxed mt-2 text-[#0B071E]/75"
                          >
                            {step.description}
                          </motion.p>
                        )}
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="glass-card p-6 flex-1 flex flex-col bg-white border-[#0B071E] shadow-[8px_8px_0px_#0B071E] relative overflow-hidden min-h-[460px] justify-between">
              
              {/* Top Bar of "Device Viewport" */}
              <div className="flex items-center justify-between border-b-2 border-dark/8 pb-4 mb-4 z-10">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-coral border border-dark/20" />
                ...
                <AnimatePresence mode="wait">
                  ...
                  {activeStep === 0 && (
                    ...
                    >
                        ...
                        {(['FAST', 'NUST', 'LUMS', 'GIKI'] as const).map((uniName) => (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-xl text-xs font-black border-2 transition-all ${
                              selectedUni === uniName
                                ? 'bg-purple border-dark text-dark shadow-[2px_2px_0px_#0B071E] -translate-y-0.5'
                                : 'bg-[#FDFBF7] border-dark/10 text-text-secondary hover:border-dark/30'
                            }`}
                          >
                            🏫 {uniName}
                          </button>
                      ...
                      <div className="glass-card p-5 border-2 border-dark/12 bg-white/95 relative overflow-hidden shadow-sm">
                        
                        {/* Dynamic University Cover Strip */}
                        <div className={`h-16 rounded-xl mb-4 bg-gradient-to-r flex items-center px-4 justify-between border-2 border-dark/8 ${
                          selectedUni === 'FAST' ? 'from-blue-600/30 to-indigo-600/20' :
                          selectedUni === 'NUST' ? 'from-purple-600/30 to-brand-600/20' :
                          selectedUni === 'LUMS' ? 'from-orange-600/30 to-red-600/20' :
                          'from-emerald-600/30 to-teal-600/20'
                        }`}>
                          <div>
                            <h4 className="font-display font-black text-lg text-dark">
                              {selectedUni === 'FAST' ? 'FAST-NUCES' :
                               selectedUni === 'NUST' ? 'NUST Islamabad' :
                               selectedUni === 'LUMS' ? 'LUMS Lahore' :
                               'GIKI Swabi'}
                            </h4>
                            <span className="text-[9px] font-black uppercase text-dark/70 flex items-center gap-1">
                              <MapPin size={10} />
                          ...
                          <span className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider border border-dark/15 ${
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div className="bg-dark/4 p-2.5 rounded-xl border border-dark/5">
                            <span className="block text-[8px] font-black uppercase text-text-muted">Degree Programs</span>
                          ...
                          <div className="bg-dark/4 p-2.5 rounded-xl border border-dark/5">
                            <span className="block text-[8px] font-black uppercase text-text-muted">Estimated Semester Fee</span>
                            <span className="text-[11px] font-black text-dark">
                        ...
                        <div className="flex gap-2">
                          ...
                          <span className="tag-purple py-0.5 px-2 text-[9px]">Fee Calculator</span>
                          <span className="tag-orange py-0.5 px-2 text-[9px]">GPA Guide</span>
                        </div>

                        <div className="mt-4 border-t border-dark/8 pt-3 flex items-center justify-between">
                          <span className="text-[10px] text-text-secondary font-semibold">
                            ★ 4.8 Rating • 1.2k applicants guided
                          </span>
                          <button className="flex items-center gap-1.5 text-xs font-black text-purple hover:underline">
                  ...
                  {activeStep === 1 && (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div>
                          <span className="text-[10px] font-black uppercase tracking-wider text-text-muted">Current Search</span>
                          <h4 className="font-display font-black text-base text-dark flex items-center gap-1.5">
                            <BookOpen size={16} className="text-coral" /> CS-201 Object Oriented Programming
                          </h4>
                        </div>
                        <span className="tag-purple text-[9px] py-0.5">FAST Lahore</span>
                      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        {[
                          ...
                          return (
                            <div 
                              key={file.name}
                              className="flex items-center justify-between p-3 rounded-xl border-2 border-dark/8 bg-white transition-all hover:border-dark/15"
                            >
                              <div className="flex items-center gap-3 min-w-0">
                                ...
                                <div className="min-w-0">
                                  <span className="block text-xs font-black text-dark truncate">
                                    {file.name}
                                  </span>
                                  <span className="text-[9px] font-extrabold text-text-muted uppercase">
                                    {file.type} • {file.size}
                                  </span>
                                </div>
                              </div>
                              ...
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-[10px] font-black border-2 transition-all flex items-center gap-1.5 ${
                                  isThisDownloaded
                                    ...
                                    : 'bg-[#FDFBF7] border-dark text-dark shadow-[1.5px_1.5px_0px_#0B071E] active:translate-y-0.5'
                                }`}
                              >
                                {isThisDownloaded ? (
                                  <>
                      ...
                      {downloadedFile && (
                        <motion.div 
                          ...
                          className="bg-emerald-50 border border-emerald-300 p-2.5 rounded-xl text-center text-xs font-semibold text-emerald-800 flex items-center justify-center gap-2"
                        >
                  ...
                  {activeStep === 2 && (
                    ...
                    >
                      ...
                      <div className="bg-[#0B071E]/5 p-4 rounded-xl border border-dark/8">
                          ...
                          return (
                            <motion.div 
                              ...
                              className={`p-3.5 rounded-xl border-2 transition-all flex flex-col md:flex-row justify-between md:items-center gap-3 ${
                                isHired 
                                  ? 'border-emerald-500 bg-emerald-50/50 shadow-[4px_4px_0px_#10B981]'
                                  : 'border-dark/8 bg-white hover:border-dark/15'
                              }`}
                            >
                              <div className="flex items-start gap-3">
                                <div className="w-10 h-10 rounded-xl bg-cyan-100 flex items-center justify-center text-cyan-700 font-display font-black text-sm flex-shrink-0">
                                  {bid.name.split(' ').map(n => n[0]).join('')}
                                </div>
                                <div>
                                  <div className="flex items-center gap-1.5">
                                    <span className="text-xs font-black text-dark">{bid.name}</span>
                                    <span className="px-1.5 py-0.5 rounded bg-dark/6 text-[8px] font-black uppercase text-purple">
                                      {bid.gpa}
                                    </span>
                                  </div>
                              ...
                              <div className="flex items-center justify-between md:justify-end gap-3 border-t md:border-t-0 border-dark/6 pt-2 md:pt-0">
                                <div>
                                  <span className="block text-[8px] font-black uppercase text-text-muted text-left md:text-right">Price Bid</span>
                                  <span className="text-sm font-black text-dark">{bid.rate}</span>
                                </div>
                                <button
                                  ...
                                  className={`px-3 py-2 rounded-lg text-xs font-black border-2 transition-all ${
                                    isHired
                                      ...
                                      : 'bg-funky-cyan border-dark text-dark shadow-[2px_2px_0px_#0B071E] active:translate-y-0.5 hover:bg-cyan-300'
                                  }`}
                                >
                      ...
                      {acceptedBid && (
                        <motion.div 
                          initial={{ opacity: 0, scale: 0.95 }}
                          animate={{ opacity: 1, scale: 1 }}
                          className="bg-[#0B071E] text-white p-4 rounded-xl flex items-center justify-between border-2 border-dark"
                        >
                  ...
                  {activeStep === 3 && (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-white p-3 rounded-xl border-2 border-dark/8 text-center shadow-sm">
                          <span className="block text-[8px] font-black text-text-muted uppercase">My Rating</span>
                          <span className="text-lg font-black text-dark flex items-center justify-center gap-0.5 mt-0.5">
                            4.95 <Star size={14} className="fill-yellow text-yellow" />
                          </span>
                        </div>
                        <div className="bg-white p-3 rounded-xl border-2 border-dark/8 text-center shadow-sm">
                          <span className="block text-[8px] font-black text-text-muted uppercase">Prep Credits</span>
                          <span className="text-lg font-black text-dark flex items-center justify-center gap-0.5 mt-0.5">
                            84 <Sparkles size={14} className="text-purple animate-pulse" />
                          </span>
                        </div>
                        <div className="bg-white p-3 rounded-xl border-2 border-dark/8 text-center shadow-sm">
                          <span className="block text-[8px] font-black text-text-muted uppercase">Withdrawable</span>
                          <span className="text-lg font-black text-emerald-600 flex items-center justify-center gap-0.5 mt-0.5">
                      ...
                      <div className="bg-white p-4 rounded-xl border-2 border-dark/8 relative shadow-sm">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-[9px] font-black uppercase text-text-muted">Weekly Tutor Income Growth</span>
                          <span className="tag-purple text-[8px] font-black">Average: Rs. 6,400/wk</span>
                        </div>
                        ...
                        <div className="h-24 w-full relative">
                          <svg className="w-full h-full" viewBox="0 0 100 30" preserveAspectRatio="none">
                            ...
                            <circle cx="30" cy="25" r="1.5" fill="#FF4B72" stroke="#0B071E" strokeWidth="0.5" />
                            <circle cx="60" cy="12" r="1.5" fill="#2EF2FF" stroke="#0B071E" strokeWidth="0.5" />
                            <circle cx="90" cy="5" r="2" fill="#FFD214" stroke="#0B071E" strokeWidth="0.5" className="animate-pulse" />
                          </svg>
                      ...
                      <div className="bg-[#0B071E]/5 p-3 rounded-xl border border-dark/6">
                        <span className="block text-[8px] font-black uppercase text-text-muted mb-1">Student Review on my profile</span>
                        <p className="text-[11px] font-bold text-dark italic leading-relaxed">
